...
const FAQCard = ({ active, onToggle, faq }) => {
	...
	return (
		<div
			className='border-[#EEEEEE] border-[1px] mb-[1rem]  relative p-[1rem] w-[90%] sm:w-[500px] lg:w-[700px] bg-[#ffffff] sm:rounded-[13px] rounded-[8px] shadow-xs'
			onClick={onToggle}>
			<h3
			...
			<span className='absolute top-5 right-5'>{active ? "-" : "+"}</span>
		</div>
	);
};
